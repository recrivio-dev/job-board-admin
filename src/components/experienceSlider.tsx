...
const ExperienceFilter = ({ 
  ...
  const updateTempFilter = useCallback((newRange: { min: number; max: number }) => {
            ...
            <div className="p-6 space-y-3">        
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xs text-slate-700">Range: {tempRange.min} - {tempRange.max} years</span>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs text-blue-600 font-semibold bg-blue-50 px-2 py-1 rounded-full">{tempRange.min}</span>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs text-purple-600 font-semibold bg-purple-50 px-2 py-1 rounded-full">{tempRange.max}</span>
                  </div>
                  <div className="relative">
                    <input
                      type="range"
